...
/**
 * Servlet implementation class Update_location
 */
...
public class Update_location extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int status=dao.updateLoaction(b, email);
		
		if(status>0) {
			request.setAttribute("mess","Location Updated Scussefully!");
			RequestDispatcher rd=request.getRequestDispatcher("/vendor/update_location.jsp");
