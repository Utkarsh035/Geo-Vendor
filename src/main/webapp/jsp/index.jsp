                ...
                <%@ include file="/WEB-INF/common/nav_bar.html" %>
                    ...
                    <section class="hero-section">
                        ...
                        <div class="hero-content">
                            ...
                            <div class="d-flex gap-3 justify-content-center flex-wrap">
                                <a href="/GeoVendor/user/user_login.jsp" class="btn-primary-platinum btn-lg">Explore
                                    Now</a>
                                <a href="/GeoVendor/vendor/vendor_registration.jsp"
                                    class="btn-outline-platinum btn-lg">Partner With Us</a>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="container bg-light-grey"> <!-- Explicit Light Grey -->
                        ...
                        <div class="row g-4 justify-content-center">
                            <% GuestDao dao=new GuestDao(); ArrayList<User> userList = dao.allFeedbacks();
                                for(User u : userList){
                    ...
                    <section class="container bg-white"> <!-- Explicit White (removed inline style) -->
                        ...
                        <div class="row g-4 justify-content-center">
                            <% VendorDao dao1=new VendorDao(); ArrayList<Vendor> vendorList = dao1.allFeedback();
                                for(Vendor v : vendorList){
                                String picName = v.getProfile_pic();
                                String picPath = request.getContextPath() + "/" + picName;
                                Vendor_feedback vf = v.getVf();
                    ...
                    <section class="cta-section">
                        <div class="container">
                            ...
                            <div class="cta-btn-group">
                                <a href="/GeoVendor/user/user_registration.jsp" class="btn-primary-platinum btn-lg">Get
                                    Started</a>
                            </div>
                        </div>
                    </section>
