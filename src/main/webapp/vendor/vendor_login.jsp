<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <title>Vendor Login | GeoVendor</title>
            ...
            <%@include file="/WEB-INF/common/nav_bar.html" %>
                <div class="login-wrapper">
                    <div class="login-card">
                        ...
                        <form action="/GeoVendor/VendorLogin" method="post" class="needs-validation" novalidate>
                            ...
                            <div class="text-center mb-3">
                                <button class="btn-platinum-submit w-100"><i class="fas fa-lock"></i> Sign In</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<% if (mess != null || mess1 != null) { %>
                    ...
                    <% if (mess != null) { %> showToast('<%= mess %>');
<% } %>
<% if (mess1 != null) { %> showToast('<%= mess1 %>');
<% } %>
<% } %>
            </script>
