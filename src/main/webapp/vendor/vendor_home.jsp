    ...
    <%@ page import="gv.dao.*, gv.beans.*, gv.utilities.*" %>
        ...
        <body>
            <% String email=(String) session.getAttribute("sessionEmail"); if (email==null || session.isNew()) {
                ...
                VendorDao dao=new VendorDao(); Vendor v=dao.vendorProfile(email); String
                ...
                <%@ include file="/vendor/vendor_header.html" %>
                    ...
                    <div class="actions-section">
                        ...
                        <div class="actions-grid">
                            <a href="/GeoVendor/vendor/business_details.jsp" class="action-btn"><i
                                    class="fas fa-plus"></i> Add Business</a>
                            <a href="/GeoVendor/vendor/business_view.jsp" class="action-btn"><i class="fas fa-eye"></i>
                                View Business</a>
                            <a href="/GeoVendor/vendor/vendor_edit.jsp" class="action-btn"><i
                                    class="fas fa-user-edit"></i> Edit Profile</a>
                            <a href="/GeoVendor/vendor/update_location.jsp" class="action-btn"><i
                                    class="fas fa-map-marker-alt"></i> Update Location</a>
                        </div>
                    </div>
