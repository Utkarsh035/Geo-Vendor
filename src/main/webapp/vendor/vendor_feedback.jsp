            ...
            <body>
                <div class="feedback-wrapper">
                    <% String email=(String)session.getAttribute("sessionEmail"); if(email==null||session.isNew()){
                        ...
                        rd.forward(request, response); } else { VendorDao dao=new VendorDao(); Vendor
                        v=dao.vendorProfile(email); String uploadPath=request.getContextPath(); String
                        imagePath=uploadPath + "/" + v.getProfile_pic(); String mess=(String)
                        request.getAttribute("message"); if (mess !=null) { %>
                        ...
                        <% } %>
                            ...
                            <%@include file="/vendor/vendor_header.html" %>
                                ...
                                <div class="feedback-card">
                                    ...
                                    <form action="/GeoVendor/VendorFeedback" method="post" novalidate
