<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@page import="gv.dao.*,gv.beans.*,gv.utilities.*" %>
        ...
        <head>
            ...
            <title>Business Edit | GeoVendor</title>
                    ...
                    <div class="edit-wrapper">
                        <div class="edit-card">
                            ...
                            <form action="/GeoVendor/BusinessEdit" method="post">
                                <p class="email-display">📧 Email: <%=bs.getEmail()%>
                                </p>
                                <div class="mb-3">
                                    <div class="field-label">Business Name</div>
                                    <input type="text" name="name" class="form-control" required
                                        value="<%=bs.getBusiness_name()%>">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="address"
                                        required><%=bs.getAddress()%></textarea>
                                </div>
                                <div class="w-100 text-center">
                                    <button class="btn-platinum-submit">Update Business</button>
                                </div>
                            </form>
                        </div>
                    </div>
