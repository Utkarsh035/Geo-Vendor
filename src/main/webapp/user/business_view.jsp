<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ page import="gv.dao.*,gv.beans.*,gv.utilities.*" %>
        ...
        <body>
            <% // Logged-in user details for header String userEmail=(String) session.getAttribute("sessionEmail");
                UserDao userDao=new UserDao(); User u=userDao.userProfile(userEmail); String
                uploadPath=request.getContextPath(); String imagePath=uploadPath + "/" + u.getProfile_pic(); %>

                <%@ include file="/user/user_header.html" %>

                    <% // Business details String businessEmail=request.getParameter("email"); if (businessEmail==null
                        ...
                        bs=vendorDao.businessProfile(businessEmail); String businessImagePath=uploadPath + "/" +
                        bs.getBusiness_photo(); %>

                        <% if (bs !=null) { %>
                            <div class="biz-wrapper">
                                <div class="card profile-card d-flex flex-md-row align-items-center">
                                ...
                                <img src="/GeoVendor/images/pin.gif" alt="pin-img" height="40" width="50"
                                    class="pin-img">
                            </div>
                            <% } else { %>
                                <div style="text-align:center; margin-top:120px; padding: 40px;">
                                    <h3 style="color: #64748b; font-family: 'Inter', sans-serif;">
                                        Business profile not found for this email.
                                    </h3>
                                </div>
                                <% } %>
