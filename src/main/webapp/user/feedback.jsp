				...
				<body>
					<div class="feedback-wrapper">
						<% String email=(String)session.getAttribute("sessionEmail"); if(email==null||session.isNew()){
							...
							else { UserDao dao=new UserDao(); User u=dao.userProfile(email); String
							...
							<% } %>
								...
								<%@include file="/user/user_header.html" %>
									...
									<div class="feedback-card">
										...
										<form action="/GeoVendor/UserFeedback" method="post" novalidate
											...
											<div class="mb-3 input-group">
												...
												<div class="form-floating">
													<input type="text" name="name" placeholder="Enter Name"
														class="form-control" required value="<%=u.getName()%>"
														readonly="readonly">
