    ...
    <% response.setHeader("Cache-Control","no-cache,no-store,must-revalidate"); response.setHeader("Pragma","no-cache");
        ...
        <%@ page import="gv.dao.*, gv.beans.*, gv.utilities.*" %>
            ...
            <head>
                ...
                <title>User Home | GeoVendor</title>
            ...
            <body>
                <% String email=(String) session.getAttribute("sessionEmail"); String role=(String)
                    session.getAttribute("role"); if (email==null || session.isNew()) { request.setAttribute("message",
                    CustomMessages.AUTHORISE_ERROR); RequestDispatcher
                    rd=request.getRequestDispatcher("/user/user_login.jsp"); rd.forward(request, response); } else {
                    if(role.equalsIgnoreCase("user")){ UserDao dao=new UserDao(); User u=dao.userProfile(email); String
                    uploadPath=request.getContextPath(); String imagePath=uploadPath + "/" + u.getProfile_pic(); %>
                    ...
                    <%@ include file="/user/user_header.html" %>
                        ...
                        <section class="profile-hero">
                            <div class="profile-hero-content">
                                ...
                                <p class="profile-tagline">Welcome back to your GeoVendor dashboard</p>
                            </div>
                        </section>
                        ...
                        <div class="actions-section">
                            ...
                            <div class="actions-grid">
                                <a href="/GeoVendor/ViewMap" class="action-btn">
                                    <i class="fas fa-map"></i> Explore Vendors
                                </a>
                                <a href="/GeoVendor/user/user_edit.jsp" class="action-btn">
                                    <i class="fas fa-user-edit"></i> Edit Profile
                                </a>
                                <a href="/GeoVendor/user/feedback.jsp" class="action-btn">
