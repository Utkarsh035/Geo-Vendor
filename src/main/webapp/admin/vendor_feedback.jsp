...
<head>
<meta charset="UTF-8">
<title>Feedbacks List(Vendor)</title>
...
<h2 style="margin-top: 65px">Vendor's Feedback List</h2>
...
ArrayList<Vendor_feedback>vfeedbacklist=dao.viewvendorFeedback();
if(vfeedbacklist.size()>0){
%>
<div class="flex-container">
<%for(Vendor_feedback vf:vfeedbacklist) {

String rt=vf.getRating();
